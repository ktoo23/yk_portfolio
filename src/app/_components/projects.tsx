  ...
  const projects: ProjectData[] = [
    {
      ...
      videos: [
        '/videos/chee/login.mp4',
        '/videos/chee/main.mp4',
        '/videos/chee/auction-list.mp4',
        '/videos/chee/auction-add.mp4',
        '/videos/chee/chat.mp4',
        '/videos/chee/profile.mp4',
        '/videos/chee/profile-update.mp4',
      ],
    },
